...
# Define signal handler and MOTOR_PIN pin
...
class Waterer(Resource):
    """API resource that handles incoming requests to turn the MOTOR_PIN on.
    ...
    def __init__(self):
        # Make sure MOTOR_PIN is off on initialisation
